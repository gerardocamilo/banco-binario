...
namespace appBancoBinario.Clientes.CapaDeNegocio
{
    ...
    public  class Clientes : SqlHelper
    {
        ...
        public void InsertClientes(ClientesDetails myClientesDetails)
        {
            ...
            SqlParameter ParameterNacionalidad = new SqlParameter("@Nacionalidad", SqlDbType.VarChar, 20);
            ParameterNacionalidad.Value = myClientesDetails.Nacionalidad;
            myCommand.Parameters.Add(ParameterNacionalidad);
            ...
            SqlParameter ParameterFecha_Nacimiento = new SqlParameter("@Fecha_Nacimiento", SqlDbType.VarChar, 10);
            ParameterFecha_Nacimiento.Value = myClientesDetails.Fecha_Nacimiento;
            ...
            SqlParameter ParameterSexo = new SqlParameter("@Sexo", SqlDbType.Char, 1);
            ParameterSexo.Value = myClientesDetails.Sexo;
