...
using Configuracion_y_Parametros;
...
public class SqlHelper
{
    ...
    protected SqlHelper(string DataBaseName, string DataBaseServer, string DataBaseUser, string DataBasePassword)
    {
        ...
        DBConnectionString = "Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=DBConfiguracionParametros;Data Source=.";
    ...
    //Protected Sub New()
    //    'DBConnectionString = ConnectionString
    //    Dim _clSeguridad As New Seguridad
    //    DBConnectionString = "server=srvwsqlvs;database=consulmed; user id=" & _clSeguridad.Usuario.ToString & "; password=" & _clSeguridad.Clave.ToString & ";"
